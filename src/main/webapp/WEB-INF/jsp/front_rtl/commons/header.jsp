...
<div role="navigation" class="navbar header no-margin">
  <div class="container">
    <div class="navbar-header">
      ...
      <a href="index.html" class="navbar-brand"><img src="assets/i/logo_red.png" alt="Metronic Shop UI"></a><!-- LOGO -->
    </div>
    <!-- BEGIN CART -->
    ...
    <div class="collapse navbar-collapse mega-menu">
      <ul class="nav navbar-nav">
          ...
          <ul class="dropdown-menu">
            <li class="dropdown-submenu">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="#">Second Level Link</a></li>
                <li class="dropdown-submenu">
                  <a href="#">Second Level Link <i class="fa fa-angle-right"></i></a>
                  <ul class="dropdown-menu">
            ...
            <li><a href="#">Tennis Clothing</a></li>
            <li class="dropdown-submenu">
              <a href="#">Running Clothing <i class="fa fa-angle-right"></i></a>
              <ul class="dropdown-menu">
                <li><a href="#">Second Level Link</a></li>
                <li><a href="#">Second Level Link</a></li>
                <li class="dropdown-submenu">
        ...
        <li><a href="http://keenthemes.com/preview/metronic_admin/ecommerce_index.html">新品上架</a></li>
        <!-- BEGIN TOP SEARCH -->
